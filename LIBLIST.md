...
| ------- | ----------- | -------- | ---------- | ----------- |
| [bootstrap](http://getbootstrap.com/) | 166.3 k | Y | 27 | The most popular front-end framework for developing responsive, mobile first projects on the web. |
| [d3](https://d3js.org) | 106.9 k | Y | 262 | A JavaScript visualization library for HTML and SVG. |
| axios | 102.9 k | Y | 84 | Promise based HTTP client for the browser and node.js |
| [three.js](http://threejs.org/) | 96.5 k | Y | 251 | JavaScript 3D library |
| [font-awesome](https://fontawesome.com/) | 72.6 k | Y | 99 | The iconic SVG, font, and CSS toolkit |
| [reveal.js](https://revealjs.com/) | 66.2 k | Y | 54 | The HTML Presentation Framework |
| [Chart.js](http://www.chartjs.org) | 62.6 k | Y | 110 | Simple HTML5 charts using the canvas element. |
| [redux](http://redux.js.org) | 60.2 k | Y | 61 | Predictable state container for JavaScript apps |
| [socket.io](https://socket.io) | 59.6 k | Y | 126 | node.js realtime framework server |
| [angular-loader](http://angularjs.org) | 59.0 k | N | 14 | Module loader for AngularJS modules. If you are loading multiple script files containing AngularJS modules, you can load them asynchronously and in any order as long as you load this file first. |
...
| [kotlin](http://kotlinlang.org) | 46.6 k | Y | 83 | Standard Library for Kotlin Applications |
| dayjs | 45.0 k | N | 116 | 2KB immutable date library alternative to Moment.js with the same modern API  |
| [admin-lte](http://almsaeedstudio.com) | 43.3 k | N | 52 | Admin dashboard and control panel template |
| [6to5](https://6to5.org/) | 42.7 k | Y | 190 | Turn ES6 code into readable vanilla ES5 with source maps |
| [babel-core](https://babeljs.io/) | 42.7 k | Y | 184 | A compiler for writing next generation JavaScript |
...
| [pixi.js](http://goodboydigital.com/) | 41.6 k | Y | 216 | Pixi.js is a fast lightweight 2D library that works across all devices. |
| [leaflet](http://leafletjs.com/) | 39.1 k | Y | 52 | JavaScript library for mobile-friendly interactive maps |
| [materialize](http://materializecss.com/) | 38.9 k | Y | 44 | Builds Materialize distribution packages |
| [quill](http://quilljs.com) | 37.8 k | Y | 81 | Cross browser rich text editor |
...
| [phaser](https://phaser.io/) | 35.7 k | Y | 153 | A fast, free and fun HTML5 Game Framework for Desktop and Mobile web browsers. |
| [ant-design-pro](https://pro.ant.design) | 35.3 k | N | 45 | An enterprise-class UI design language and React-based implementation |
| [fullPage.js](http://alvarotrigo.com/fullPage/) | 34.8 k | Y | 93 | Create beautiful fullscreen snap scrolling websites |
...
| [ramda](https://www.github.com/ramda/ramda) | 23.4 k | Y | 56 | A practical functional library for JavaScript programmers. |
...
| [fullcalendar](http://fullcalendar.io/) | 17.4 k | Y | 109 | Full-sized drag & drop event calendar |
...
| [barba.js](http://barbajs.org) | 11.2 k | Y | 11 | Barba.js it's a small, flexible and dependency free library that helps you creating fluid and smooth transition between your website's pages. |
...
| [js-xss](http://jsxss.com) | 5.0 k | N | 62 | Sanitize untrusted HTML (to prevent XSS) with a configuration specified by a Whitelist |
